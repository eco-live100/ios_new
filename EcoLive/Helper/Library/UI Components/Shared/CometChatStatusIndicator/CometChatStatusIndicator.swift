...
@objc @IBDesignable  class CometChatStatusIndicator: UIView {
    ...
    @IBInspectable var border_Color: UIColor = UIColor.black
    @IBInspectable var border_Width: CGFloat = 0.5
    ...
    override  func draw(_ rect: CGRect) {
        ...
        UIBezierPath(roundedRect: bounds, cornerRadius: corner_Radius).fill()
        let borderRect = bounds.insetBy(dx: border_Width/2, dy: border_Width/2)
        let borderPath = UIBezierPath(roundedRect: borderRect, cornerRadius: corner_Radius - border_Width/2)
