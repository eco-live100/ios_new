...
fileprivate extension ACFloatingTextfield {
    ...
    func addFloatingLabel() {
        ...
        labelPlaceholder?.font = UIFont.init(name: Constants.Font.ROBOTO_MEDIUM, size: 15.0) //UIFont.init(name: (self.font?.fontName ?? "helvetica")!, size: 12)
    ...
    func addErrorPlaceholderLabel() -> Void {
        ...
        labelErrorPlaceholder?.font = UIFont.init(name: Constants.Font.ROBOTO_MEDIUM, size: 15.0) //UIFont(name: (self.font?.fontName ?? "helvetica")!, size: 12)
