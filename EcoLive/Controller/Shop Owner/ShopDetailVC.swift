...
//        self.clView.isHidden = true
        ...
        self.btnOutofStock.setTitle("Out of stock (0)", for: [])
    ...
    @IBAction func btnEditClick(_ sender: UIButton) {
        let controller = GlobalData.shopOwnerStoryBoard().instantiateViewController(withIdentifier: "AddShopInfoVC") as! AddShopInfoVC
        controller.strShopID = self.strShopID
        controller.objShopDetail = self.objShopDetail
        controller.arrProductList = self.arrProductList
    ...
    @IBAction func btnOutofStockClick(_ sender: UIButton) {
        self.btnOutofStock.backgroundColor =  Constants.Color.THEME_YELLOW
        self.btnOutofStock.setTitleColor(UIColor.white, for: [])
        
        self.btnAllProduct.backgroundColor = UIColor.init(hex: 0xD4D4D4)
        self.btnAllProduct.setTitleColor(UIColor.init(hex: 0x333333), for: [])
...
extension ShopDetailVC: UISearchBarDelegate {
...
extension ShopDetailVC: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
