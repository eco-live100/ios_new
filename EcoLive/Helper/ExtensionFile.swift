...
//        layer.shadowPath = UIBezierPath(rect: self.bounds).cgPath
    ...
    func drawShadow(borderWidth : Double = 0.3) {
        self.layer.borderColor = UIColor.init(hex: 0xEFEFEF).cgColor
        self.layer.borderWidth = borderWidth
        
        self.layer.masksToBounds = false
        self.layer.shadowRadius = 1
        self.layer.shadowOpacity = 0.6
        self.layer.shadowColor = UIColor.init(hex: 0xEFEFEF).cgColor
        self.layer.shadowOffset = CGSize(width: 0, height: 2)
    }
    
    func createButtonShadow() {
        self.layer.borderColor = UIColor.init(hex: 0x000000, a: 0.3).cgColor
...
extension String {
    func fromUTCToLocalDateTime(OutputFormat outputFormat: String) -> String {
        ...
        dateFormatter.dateFormat = outputFormat//"EEE, MMM d, yyyy - h:mm a"
...
extension NSDictionary {
    ...
    func getApiErrorMessage() -> String{
        var message = ""
        message = self.value(forKey: "msg") as? String ?? "No content found"
        return message
    }
