//
//  AddProductEcomDelegetDataSource.swift
//  DemoApp
//
//  Created by  on 22/11/22.
//
...
extension AddProductEcom : UICollectionViewDataSource,UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
