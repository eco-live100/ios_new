...
class RiderReview: BaseVC {

    @IBOutlet weak var clView: UICollectionView!
    @IBOutlet weak var clView2: UICollectionView!
    
    var titleArray = ["Service was perfect","I am mostly satisfied"]
    var titleArray2 = ["Was not Clean","Wasn't polite or respectful","Agents were not responsive","They don't care about the environment","I'm not happy"]
...
//        )
//
//        clView.collectionViewLayout = alignedFlowLayout
//        clView2.collectionViewLayout = alignedFlowLayout
...
extension RiderReview : UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout{
...
class ReviewSuggetionCell : UICollectionViewCell {
