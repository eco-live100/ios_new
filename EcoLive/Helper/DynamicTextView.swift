...
@objc public protocol DynamicTextViewDelegate: UITextViewDelegate {
    @objc optional func textViewDidChangeHeight(_ textView: DynamicTextView, height: CGFloat)
}
...
open class DynamicTextView: UITextView {
    ...
    override open func layoutSubviews() {
        ...
        if height != heightConstraint!.constant {
            ...
            if let delegate = delegate as? DynamicTextViewDelegate {
    ...
    @objc func textDidEndEditing(notification: Notification) {
        if let sender = notification.object as? DynamicTextView, sender == self {
